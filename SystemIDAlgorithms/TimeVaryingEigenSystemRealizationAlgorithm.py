...
def timeVaryingEigenSystemRealizationAlgorithm(Y, hki, D, full_experiment, state_dimension, p, q, **kwargs):
    ...
    # Get xq
    full_experiment_input_q = DiscreteSignal(full_experiment.input_signals[0].dimension, full_experiment.input_signals[0].name,
    ...
    full_experiment_output_q = DiscreteSignal(full_experiment.output_signals[0].dimension, full_experiment.output_signals[0].name,
