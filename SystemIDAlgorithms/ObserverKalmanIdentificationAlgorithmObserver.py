...
def observerKalmanIdentificationAlgorithmObserver(input_signal, output_signal, deadbeat_order):
    ...
    # Build matrix U
    U = np.zeros([(input_dimension + output_dimension) * deadbeat_order + input_dimension, number_steps])
